...
devtools::install_github("pengjiao/igseq")
```
...
4. Build igblast database from IMGT reference sequences. This script is modified from fetch_imgtdb.sh of the [immcantation](https://bitbucket.org/kleinstein/immcantation/src/master/scripts/fetch_imgtdb.sh) workflow, with the addition of downloading IGHJ amino acid.
```bash
